...
from start_cooking_button import start_cooking_button, handle_start_cooking_button
...
while run:
    ...
    for event in pygame.event.get():
     ...
     # Event to handle the "Start Cooking" button
    start_cooking_clicked, selected_ingredients = handle_start_cooking_button(
        screen, event, start_cooking_clicked, selected_ingredients, level_ingredients, result_message
    )
